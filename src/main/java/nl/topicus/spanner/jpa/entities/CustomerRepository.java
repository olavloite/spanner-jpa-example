...
public interface CustomerRepository extends CrudRepository<Customer, Long>
{
	/**
	 * 
	 * @return The last commit timestamp from Cloud Spanner. This query does not
	 *         actually do a round trip to Cloud Spanner, but fetches a value
	 *         stored in memory in the Cloud Spanner JDBC connection. Note that
	 *         this query is not specific for the Customer entity or this
	 *         repository, but could be used in any context to get the latest
	 *         commit timestamp returned by Cloud Spanner.
	 */
